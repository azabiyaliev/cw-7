...
const ChooseProduct:React.FC<ChooseProductProps> = ({title, count, price, deleteProduct}) => {
    return (
        <div className='order'>
            <h3 className='orderTitle'>{title}</h3>
            <p className='ordered'>Ordered: x{count}, Price: {price} KGS</p>
